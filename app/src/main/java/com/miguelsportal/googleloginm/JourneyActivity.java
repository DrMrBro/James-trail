...
public class JourneyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String product_Id = getIntent().getStringExtra(TrailActivity.PRODUCT_ID);
        Trail trail = DataProvider.trailMap.get(product_Id);
        ...
        descView.setText(trail.getDescription());
